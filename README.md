...
-[arxiv-2024]Generalized Out-of-Distribution Detection and Beyond in Vision Language Model Era: A Survey[[paper](https://arxiv.org/pdf/2407.21794)][[web page](https://github.com/AtsuMiyai/Awesome-OOD-VLM)]
...
- [arxiv-2022]Knowledge Distillation Meets Open-Set Semi-Supervised Learning[[paper](https://arxiv.org/pdf/2205.06701)]
...
- [ NeurIPS-2021 ] OpenMatch: Open-Set Semi-supervised Learning with Open-set Consistency Regularization [[paper](https://proceedings.neurips.cc/paper/2021/hash/da11e8cd1811acb79ccf0fd62cd58f86-Abstract.html)] [[code](https://github.com/VisionLearningGroup/OP_Match)][[author](https://ksaito-ut.github.io/cv_public.pdf)]
- [ ICCV-2021 ] Trash to Treasure: Harvesting OOD Data with Cross-Modal Matching for Open-Set Semi-Supervised Learning [[paper](http://openaccess.thecvf.com/content/ICCV2021/html/Huang_Trash_To_Treasure_Harvesting_OOD_Data_With_Cross-Modal_Matching_for_ICCV_2021_paper.html)] [[code](https://github.com/huangjk97/T2T)][[supplementary](https://openaccess.thecvf.com/content/ICCV2021/supplemental/Huang_Trash_To_Treasure_ICCV_2021_supplemental.pdf)]
...
- [ ECCV-2020 ] Multi-task curriculum framework for open-set semi-supervised learning [[paper](https://link.springer.com/chapter/10.1007/978-3-030-58610-2_26)] [[code](https://github.com/YU1ut/Multi-Task-Curriculum-Framework-for-Open-Set-SSL)][[author](https://yu1ut.com/)]
